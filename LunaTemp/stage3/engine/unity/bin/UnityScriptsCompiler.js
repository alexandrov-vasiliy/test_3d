                            ...
                            switch ($step) {
                                ...
                                case 2: {
                                    duration = this.GetDuration(this.baseDisappearDuration);
                                        ...
                                        effectPosition = stackView.transform.position.$clone();
...
if ( TRACE ) { TRACE( "_Game.Tutorial.TutorialHandController#PlayLoop", this ); }
                ...
                this.sequence != null ? DG.Tweening.TweenExtensions.Kill(this.sequence) : null;
                var from = this.WorldToScreenPosition(this.tutorialTargetStack.transform.position).add( this.screenOffset );
                var to = this.WorldToScreenPosition(this.tutorialTargetCell.transform.position).add( this.screenOffset );
                this.handRect.position = UnityEngine.Vector3.FromVector2(from.$clone());

                this.sequence = DG.Tweening.DOTween.Sequence();
                DG.Tweening.TweenSettingsExtensions.Append(this.sequence, DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.handRect, UnityEngine.Vector3.FromVector2(to.$clone()), this.handMoveDuration), DG.Tweening.Ease.InOutSine));
                DG.Tweening.TweenSettingsExtensions.AppendInterval(this.sequence, 0.35);
                DG.Tweening.TweenSettingsExtensions.Append(this.sequence, DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.handRect, UnityEngine.Vector3.FromVector2(from.$clone()), 0.25), DG.Tweening.Ease.OutSine));
            ...
            /*_Game.Tutorial.TutorialHandController.WorldToScreenPosition start.*/
            WorldToScreenPosition: function (worldPosition) {
if ( TRACE ) { TRACE( "_Game.Tutorial.TutorialHandController#WorldToScreenPosition", this ); }
                ...
                return new pc.Vec2( screenPosition.x, screenPosition.y );
            },
            /*_Game.Tutorial.TutorialHandController.WorldToScreenPosition end.*/
...
if ( TRACE ) { TRACE( "_Game.Tutorial.TutorialHandController#EnsureOverlayCanvas", this ); }
                ...
                if (UnityEngine.Component.op_Equality(this.canvas, null)) {
                    this.canvas = this.gameObject.AddComponent(UnityEngine.Canvas);
                }

                this.canvas.renderMode = UnityEngine.RenderMode.ScreenSpaceOverlay;
                this.canvas.sortingOrder = 5000;
                this.canvas.overrideSorting = true;

                var scaler = this.GetComponent(UnityEngine.UI.CanvasScaler);
                if (UnityEngine.MonoBehaviour.op_Equality(scaler, null)) {
                    scaler = this.gameObject.AddComponent(UnityEngine.UI.CanvasScaler);
                }
                scaler.uiScaleMode = UnityEngine.UI.CanvasScaler.ScaleMode.ScaleWithScreenSize;
                scaler.referenceResolution = new pc.Vec2( 1080.0, 1920.0 );
...
if ( TRACE ) { TRACE( "_Game.Tutorial.TutorialHandController#EnsureHandImage", this ); }
                ...
                if (UnityEngine.MonoBehaviour.op_Equality(this.handImage, null)) {
                    var handObject = new UnityEngine.GameObject.$ctor2("TutorialHandImage");
                    handObject.transform.SetParent(this.transform, false);
                    this.handImage = handObject.AddComponent(UnityEngine.UI.Image);
                }
