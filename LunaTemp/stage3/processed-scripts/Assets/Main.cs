...
public class Main : MonoBehaviour
{
    ...
    private static void Place(BoardController board, [Bridge.Ref] Vector2Int coordinate, HexStack stack)
    {
    ...
    private static LevelConfig.BoardStackDefinition CreateBoardStack([Bridge.Ref] Vector2Int coordinate, params HexColor[] colors)
    {
