...
namespace _Game.Board
{
    public class BoardController : MonoBehaviour
    {
        ...
        public HexCell GetCell([Bridge.Ref] Vector2Int coordinate)
        {
            foreach (HexCell cell in cells.Values)
            {
        ...
        public HexCell GetCellUnderPointer([Bridge.Ref] Vector2 screenPosition)
        {
        ...
        public HexStackView CreateStackView(HexStack stack, Transform parent, [Bridge.Ref] Vector3 position)
        {
        ...
        private bool TryGetWorldPointOnBoardPlane(Camera cam, [Bridge.Ref] Vector2 screenPosition, out Vector3 world)
        {
        ...
        private static float DistanceXZ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b)
        {
