...
namespace _Game.Board
{
    public class BoardOutline : MonoBehaviour
    {
        ...
        private void AddHexPrism([Bridge.Ref] Vector2Int coordinate, HexCellView cellView, Dictionary<Vector2Int, HexCellView> cells, List<Vector3> vertices, List<int> triangles)
        {
        ...
        private void AddHexCap([Bridge.Ref] Vector3 centre, Vector3[] corners, bool topFace, List<Vector3> vertices, List<int> triangles)
        {
        ...
        private void AddQuad([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c, [Bridge.Ref] Vector3 d, List<Vector3> vertices, List<int> triangles)
        {
            int baseIndex = vertices.Count;
        ...
        private Vector3Int Quantize([Bridge.Ref] Vector3 value)
        {
        ...
        private int FindSideIndex(HexCellView cellView, [Bridge.Ref] Vector2Int neighbourCoordinate)
        {
        ...
        private void CreateBorderSide([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end)
        {
            if (useGlow)
            {
        ...
        private void CreateLine([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, float width, [Bridge.Ref] Color color, string objectName)
        {
        ...
        private Material CreateLineMaterial([Bridge.Ref] Color color)
        {
