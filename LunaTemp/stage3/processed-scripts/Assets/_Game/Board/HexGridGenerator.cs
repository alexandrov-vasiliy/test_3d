...
namespace _Game.Board
{
    public class HexGridGenerator : MonoBehaviour
    {
        ...
        public Vector3 CoordinateToWorld([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        public List<Vector2Int> GetNeighbourCoordinates([Bridge.Ref] Vector2Int coordinate)
        {
            BoardShape layoutShape = GetLayoutShape();
            if (layoutShape == BoardShape.Square)
            {
        ...
        public bool ContainsCustomCoordinate([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        public void AddCustomCoordinate([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        public void RemoveCustomCoordinate([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        private Vector3 FlatTopOffsetToWorld([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        private Vector3 PointyTopOffsetToWorld([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        private Vector3 FlatTopAxialToWorld([Bridge.Ref] Vector2Int coordinate)
        {
            float x = cellSize * 1.5f * coordinate.x;
        ...
        private Vector3 PointyTopAxialToWorld([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        private static List<Vector2Int> GetFlatTopOffsetNeighbours([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        private static List<Vector2Int> GetPointyTopOffsetNeighbours([Bridge.Ref] Vector2Int coordinate)
        {
            Vector2Int[] evenRow =
            {
                new Vector2Int(1, 0),
        ...
        private static List<Vector2Int> GetAxialNeighbours([Bridge.Ref] Vector2Int coordinate)
        {
        ...
        private static List<Vector2Int> OffsetNeighbours([Bridge.Ref] Vector2Int coordinate, Vector2Int[] offsets)
        {
            List<Vector2Int> neighbours = new List<Vector2Int>(offsets.Length);
            for (int i = 0; i < offsets.Length; i++)
            {
                Vector2Int offset = offsets[i];
                neighbours.Add(new Vector2Int(coordinate.x + offset.x, coordinate.y + offset.y));
            }
        ...
        private static int CompareCoordinates([Bridge.Ref] Vector2Int a, [Bridge.Ref] Vector2Int b)
        {
