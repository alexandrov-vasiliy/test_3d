...
namespace _Game.Stacks
{
    public class StackTrayController : MonoBehaviour
    {
        ...
        public HexStackView GetStackUnderPointer([Bridge.Ref] Vector2 screenPosition, Camera inputCamera)
        {
        ...
        private bool TryGetWorldPointOnTrayPlane(Camera cam, [Bridge.Ref] Vector2 screenPosition, out Vector3 world)
        {
