...
namespace _Game.Board
{
    public class HexGridGenerator : MonoBehaviour
    {
        ...
        public List<Vector2Int> GetNeighbourCoordinates(Vector2Int coordinate)
        {
            BoardShape layoutShape = GetLayoutShape();
            if (layoutShape == BoardShape.Square)
            {
        ...
        private static List<Vector2Int> GetFlatTopOffsetNeighbours(Vector2Int coordinate)
        {
        ...
        private static List<Vector2Int> GetPointyTopOffsetNeighbours(Vector2Int coordinate)
        {
            Vector2Int[] evenRow =
            {
                new Vector2Int(1, 0),
        ...
        private static List<Vector2Int> GetAxialNeighbours(Vector2Int coordinate)
        {
        ...
        private static List<Vector2Int> OffsetNeighbours(Vector2Int coordinate, Vector2Int[] offsets)
        {
